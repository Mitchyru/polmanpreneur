    ...
    <div class="col-md-8">
      <div class="card">
        <div class="card-header">
          <div class="row">
            <div class="col-8">
              <h4 class="card-title">Insert Your Product</h4>
            </div>
              ...
              <form method="post" action="/add" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="form-group{{ $errors->has('desc') ? ' has-danger' : '' }}">
                    ...
                    <input type="text" name="desc" class="form-control{{ $errors->has('desc') ? ' is-invalid' : '' }}" placeholder="{{ __('Description') }}" value="{{ old('desc') }}">
                  ...
                  <div class="mb-3">
                    ...
                    <br>
                    <label>{{ __('*Recomended Image Dimensions : 800 x 800') }}</label>
                    <input 
                      accept="image/*"
                      type="file" 
                      name="image" 
