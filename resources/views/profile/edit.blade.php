                ...
                <form method="post" action="{{ route('profile.update') }}" autocomplete="off">
                    <div class="card-body">
                            ...
                            <div class="form-group{{ $errors->has('nim') ? ' has-danger' : '' }}">
                                <label>{{ __('NIM') }}</label>
                                <input type="text" name="nim" class="form-control{{ $errors->has('nim') ? ' is-invalid' : '' }}" placeholder="{{ __('NIM') }}" value="{{ old('nim', auth()->user()->nim) }}" disabled>
                                @include('alerts.feedback', ['field' => 'nim'])
                            </div>
                            ...
                            <div class="form-group{{ $errors->has('notelp') ? ' has-danger' : '' }}">
                                ...
                                <input type="text" name="notelp" class="form-control{{ $errors->has('notelp') ? ' is-invalid' : '' }}" placeholder="{{ __('No Telp') }}" value="{{ old('notelp', auth()->user()->notelp) }}">
